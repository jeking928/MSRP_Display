...
// hidden fields not changeable on products page
  ...
  <div class="well" style="color: #31708f;background-color: #d9edf7;border-color: #bce8f1;;padding: 10px 10px 0 0;">
    ...
    <div class="form-group">
        <?php echo zen_draw_label(TEXT_PRODUCTS_PRICE_MSRP, 'products_msrp', 'class="col-sm-3 control-label"'); ?>
      <div class="col-sm-9 col-md-6">
          <?php echo zen_draw_input_field('products_price', $pInfo->products_msrp, 'class="form-control"'); ?>
      </div>
    </div>
    <div class="form-group">
